...
class ServerStatusIntentHandler(AbstractRequestHandler):
    """Handler for Server Status Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("ServerStatusIntent")(handler_input)
...
class IntentReflectorHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "You just triggered " + intent_name + ". This intent is not implemented."
